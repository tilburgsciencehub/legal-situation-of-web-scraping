...
![](img/motivation.jpg){fig-align="centre"}
...
## ![](img/legal-icon.png) Legal Challenges
...
![](img/legal-situation.jpg){fig-align="centre"}
...
### ![](img/research-exception-icon.png) Research exceptions in copyright laws {.smaller}
...
-   This results in the varied and inconsistent landscape of exceptions (see image).
:::
...
## Personal Data
![](img/personal-data.jpg){fig-align="centre"}
