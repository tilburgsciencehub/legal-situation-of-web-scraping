...
-   While certain activities such as research, teaching, parody, critique, news reporting, or commentary may be exempt from copyright law, each potential infringement must be evaluated on a case-by-case basis, as copyright issues are not always unambiguous.
...
:::
::: {.column width="50%"}
![Browsewrap](img/browsewrap.png){fig-align="left"}
:::
:::
